...
// McpServerDefinitionSpec defines the desired state of McpServerDefinition.
type McpServerDefinitionSpec struct {
	ServerDetail `json:"server_detail"`
}

// McpServerDefinitionStatus defines the observed state of McpServerDefinition.
type McpServerDefinitionStatus struct {
...
// McpServerDefinition is the Schema for the mcpserverdefinitions API.
type McpServerDefinition struct {
	metav1.TypeMeta   `json:",inline"`
	metav1.ObjectMeta `json:"metadata,omitempty"`

	Spec   McpServerDefinitionSpec   `json:"spec,omitempty"`
	Status McpServerDefinitionStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// McpServerDefinitionList contains a list of McpServerDefinition.
type McpServerDefinitionList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []McpServerDefinition `json:"items"`
}

func init() {
	SchemeBuilder.Register(&McpServerDefinition{}, &McpServerDefinitionList{})
}
